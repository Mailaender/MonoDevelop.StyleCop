//-----------------------------------------------------------------------
// <copyright file="SolutionFullAnalysisHandler.cs">
//   APL 2.0
// </copyright>
// <license>
...
namespace MonoDevelop.StyleCop
{
  ...
  /// </summary>
  internal sealed class SolutionFullAnalysisHandler : SolutionAnalysisHandler
  {
    #region Constructor

    /// <summary>
    /// Initializes a new instance of the <see cref="SolutionFullAnalysisHandler"/> class.
    /// </summary>
    public SolutionFullAnalysisHandler()
      : base(true)
    {
    }
